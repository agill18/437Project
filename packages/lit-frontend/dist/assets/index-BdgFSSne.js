 ...
 */const X=r=>r??v;var $s=Object.defineProperty,Ps=Object.getOwnPropertyDescriptor,ar=(r,e,t,s)=>{for(var i=s>1?void 0:s?Ps(e,t):e,o=r.length-1,n;o>=0;o--)(n=r[o])&&(i=(s?n(e,t,i):n(i))||i);return s&&i&&$s(e,t,i),i};let Oe=class extends y{constructor(){super(...arguments),this.on=!1}render(){const r=localStorage.getItem("dark-mode")==="true";return d`
  ...
  `;ar([m({reflect:!0,type:Boolean})],Oe.prototype,"on",2);Oe=ar([b("toggle-switch")],Oe);var Es=Object.defineProperty,xs=Object.getOwnPropertyDescriptor,lr=(r,e,t,s)=>{for(var i=s>1?void 0:s?xs(e,t):e,o=r.length-1,n;o>=0;o--)(n=r[o])&&(i=(s?n(e,t,i):n(i))||i);return s&&i&&Es(e,t,i),i};let Se=class extends y{constructor(){super(),this.customId="id",this.addEventListener("call-modals-close-modal",this.closeModal)}render(){return d`
      <button 
  ...
  `;mt([m({attribute:!1})],he.prototype,"using",2);he=mt([b("user-profile-2")],he);let st=class extends he{render(){var r;return this.profile?d`<form @submit=${this._handleSubmit}>
    ...
    `;j([D()],R.prototype,"currentPage",2);j([D()],R.prototype,"loginStatus",2);j([D()],R.prototype,"errorMessage",2);j([D()],R.prototype,"isSuccess",2);j([tr({context:Pr}),D()],R.prototype,"user",2);j([m({type:Boolean})],R.prototype,"passwordVisible",2);R=j([b("auth-container")],R);let Ue=class extends y{constructor(){super(...arguments),this.isSuccess=!1}getClassnameForPage(){return this.isSuccess?"success-message":"error-message"}render(){return d`
    ...
    `;j([m({type:Boolean})],Ue.prototype,"isSuccess",2);Ue=j([b("render-error")],Ue);var Si=Object.defineProperty,Mi=Object.getOwnPropertyDescriptor,Er=(r,e,t,s)=>{for(var i=s>1?void 0:s?Mi(e,t):e,o=r.length-1,n;o>=0;o--)(n=r[o])&&(i=(s?n(e,t,i):n(i))||i);return s&&i&&Si(e,t,i),i};let Ie=class extends y{constructor(){super(...arguments),this.open=!1}render(){return d`
      <input
        type="checkbox"
        id="is-shown"
        @change=${this._handleChange}
  ...
  `;Er([m({reflect:!0,type:Boolean})],Ie.prototype,"open",2);Ie=Er([b("drop-down")],Ie);var ki=Object.defineProperty,Di=Object.getOwnPropertyDescriptor,gt=(r,e,t,s)=>{for(var i=s>1?void 0:s?Di(e,t):e,o=r.length-1,n;o>=0;o--)(n=r[o])&&(i=(s?n(e,t,i):n(i))||i);return s&&i&&ki(e,t,i),i};let pe=class extends y{constructor(){super(...arguments),this.user=new S}render(){return d`
        <link rel="stylesheet" href="/styles/club-info.css" />
        <link rel="stylesheet" href="/styles/page.css" />
        <link rel="stylesheet" href="/styles/tokens.css" />
        <link rel="stylesheet" href="/styles/reset.css" />
  ...
  `;ve([m({attribute:!1})],W.prototype,"location",2);ve([m({reflect:!0})],W.prototype,"_id",1);ve([m({reflect:!0})],W.prototype,"host",1);ve([m()],W.prototype,"event",1);W=ve([b("event-view")],W);const ao=[{path:"/app/club/:name",component:"club-view",action:()=>{console.log("Navigating to /app/club/:name")}},{path:"/app/profile/:email",component:"profile-view",action:()=>{console.log("Navigating to /app/profile/:email")}},{path:"/app/event/:host/:_id",component:"event-view",action:()=>{console.log("Navigating to /app/event/:host/:_id")}},{path:"/app",component:"home-view",action:r=>(console.log("Navigating to /app"),localStorage.getItem(Ae)?"home-view":r.redirect("/"))},{path:"/",component:"blank-view",action:()=>{console.log("Navigating to /")}},{path:"(.*)",redirect:"/app"}],_=ws(),lo=_.update;_.addMessage("ProfileSaved",r=>{const{email:e,profile:t}=r;return new w(t).put(`/profile/${e}`).then(s=>{if(s.status===200)return s.json()}).then(s=>{if(s)return console.log("Profile:",s),s}).then(s=>s?P({profile:s}):E)});_.addMessage("MemberDeleted",r=>{const{email:e,club_name:t}=r;return new te().post(`/members/delete/${t}/${e}`).then(s=>{if(s.status===200)return s.json()}).then(s=>{if(s)return console.log("Member:",s),s}).then(()=>new w(void 0).get(`/members/${t}`).then(s=>{if(s.status===200)return s.json()}).then(s=>{if(s)return console.log("Members:",s),s}).then(s=>s?P({members:s}):E))});_.addMessage("MemberSaved",r=>{const{member:e,club_name:t}=r;return new w(e).post("/members").then(s=>{if(s.status===200)return s.json()}).then(s=>{if(s)return console.log("Member:",s),s}).then(()=>new w(void 0).get(`/members/${t}`).then(s=>{if(s.status===200)return s.json()}).then(s=>{if(s)return console.log("Members:",s),s}).then(s=>s?P({members:s}):E))});_.addMessage("UserLoggedIn",(r,e)=>{const{user:t}=r;return console.log("Dispatched UserLoggedIn"),P({user:t})(e)});_.addMessage("ProfileSelected",r=>{const{email:e}=r;return new te().get(`/profile/${e}`).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("Profile:",t),t}).then(t=>t?P({profile:t}):E)});_.addMessage("GetMyProfile",r=>{const{email:e}=r;return new te().get(`/profile/${e}`).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("My Profile:",t),t}).then(t=>t?P({myProfile:t}):E)});_.addMessage("GetClubSummaries",r=>(console.log("Dispatched GetClubSummaries"),new w(void 0).get("/clubSummaries").then(e=>{if(e.status===200)return e.json()}).then(e=>{if(e)return console.log("ClubSummaries:",e),e}).then(e=>e?P({clubSummaries:e}):E)));_.addMessage("GetEvents",r=>{const{host:e}=r;return console.log("Dispatched GetEvents"),new w(void 0).get(`/events/${e}`).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("Events:",t),t}).then(t=>t?P({events:t}):E)});_.addMessage("GetMembers",r=>{const{club_name:e}=r;return console.log("Dispatched GetMembers"),new w(void 0).get(`/members/${e}`).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("Members:",t),t}).then(t=>t?P({members:t}):E)});_.addMessage("EventSelected",r=>{const{_id:e,host:t}=r;return new te().get(`/events/${t}/${e}`).then(s=>{if(s.status===200)return s.json()}).then(s=>{if(s)return console.log("Event:",s),s}).then(s=>s?P({event:s}):E)});_.addMessage("ClubSelected",r=>{const{name:e}=r;return new te().get(`/clubs/${e}`).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("Club:",t),t}).then(t=>t?P({club:t}):E)});_.addMessage("CreateEvent",r=>{console.log("Dispatched CreateEvent");const{event:e,host:t}=r;return new w(e).post("/events").then(s=>{if(s.status===201)return s.json()}).then(s=>{if(s)return console.log("Event:",s),s}).then(()=>new w(void 0).get(`/events/${t}`).then(s=>{if(s.status===200)return s.json()}).then(s=>{if(s)return console.log("Events:",s),s}).then(s=>s?P({events:s}):E))});_.addMessage("ClubSaved",r=>{const{name:e,club:t}=r;return new w(t).put(`/clubs/${e}`).then(s=>{if(s.status===200)return s.json()}).then(s=>{if(s)return console.log("Club:",s),s}).then(s=>s?P({club:s}):E)});_.addMessage("GetProfiles",()=>new te().get("/profile/all").then(e=>{if(e.status===200)return e.json()}).then(e=>{if(e)return console.log("Profiles:",e),e}).then(e=>e?P({profiles:e}):E));_.addMessage("CreateClub",r=>{console.log("Dispatched CreateClub");const{club:e}=r;return new w(e).post("/clubs").then(t=>{if(t.status===201)return t.json()}).then(t=>{if(t)return console.log("Club:",t),t}).then(()=>new w(void 0).get("/clubSummaries").then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("ClubSummaries:",t),t}).then(t=>t?P({clubSummaries:t}):E))});var co=Object.defineProperty,ho=Object.getOwnPropertyDescriptor,uo=(r,e,t,s)=>{for(var i=s>1?void 0:s?ho(e,t):e,o=r.length-1,n;o>=0;o--)(n=r[o])&&(i=(s?n(e,t,i):n(i))||i);return s&&i&&co(e,t,i),i};let nt=class extends y{render(){return d`
        <div> 
