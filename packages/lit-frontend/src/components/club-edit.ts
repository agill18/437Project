...
@customElement("club-edit")
export class ClubEditElement extends App.View {
    ...
    return html`
      ...
      >
        ...
        <div class="table-format">
            <label>
                <span> Tags </span>
                <input name="tags" type="text" value=${this.club.tags?.join(", ")} required default="enter comma seperated list">
            </label>
            <label>
  ...
  static styles = css`
   ...
   _handleSubmit(ev: Event) {
    ...
    // Since diabled fields don't automatically get included 
